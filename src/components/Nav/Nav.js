...
const Nav = ( props ) => (
    <ul className={classes.Nav}>
        ...
        <li className={classes.NavItem}><Link to='/blog/'><Button color='teal' Active={ props.location.includes('blog') ? true : null } Large={true}>Blog</Button></Link></li>
        <li className={classes.NavItem}><Link to='/about/'><Button color='teal' Active={ props.location === '/about/' ? true : null } Large={true}>About</Button></Link></li>
